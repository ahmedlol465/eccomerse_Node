...
router.put("/updateuser", auth(endPointsRoles.ALL),expressAsynchandler(Authcontroller.updateProfile));
router.delete("/delete", auth(endPointsRoles.ALL),expressAsynchandler(Authcontroller.deleteProfile));
router.get("/getUserData",auth(endPointsRoles.ALL), expressAsynchandler(Authcontroller.getUserData));
